          ...
          <div className='w-full max-w-lg max-md:mx-auto backdrop-blur-sm border border-white/10 rounded-xl p-8'>
            {success ? (
              <div className='flex flex-col items-center justify-center h-full py-16 text-center'>
                ...
                <p className='text-slate-400 text-sm'>Hum jald reply karenge.</p>
              </div>
            ) : (
              <form className='space-y-5' onSubmit={handleSubmit}>
                <div>
                  <label className='block text-white text-sm mb-2'>Name</label>
                  <input name="name" type="text" required placeholder="Aman Singh"
                ...
                <div>
                  <label className='block text-white text-sm mb-2'>Mobile (Optional)</label>
                ...
                <div>
                  ...
                  <textarea name="message" placeholder="Write your message here..." rows={4} required
...
<section className='px-6 pb-16 max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6'>
  ...
  <div className='border border-white/10 rounded-xl p-6 bg-white/5 backdrop-blur-sm'>
    ...
    <p className='text-slate-400 text-sm mb-3'>Get instant updates & support</p>
  ...
  <div className='border border-white/10 rounded-xl p-6 bg-white/5 backdrop-blur-sm'>
    ...
    <p className='text-slate-400 text-sm mb-3'>Join our student community for quick help</p>
