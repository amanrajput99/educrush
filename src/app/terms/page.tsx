          ...
          <div className="grid grid-cols-1 lg:grid-cols-[200px_1fr] gap-10">
            ...
            <div className="space-y-3" ref={contentRef}>
              {sections.map((section, idx) => (
                ...
                >
                  {/* Section header */}
                  <div className={`flex items-center gap-3 px-5 sm:px-6 py-4 border-b transition-colors duration-300 ${activeId === section.id ? 'border-emerald-900/50' : 'border-gray-800/60'
                    }`}>
                    <span className={`shrink-0 text-[11px] font-mono font-semibold px-2 py-0.5 rounded border transition-all duration-300 ${activeId === section.id
