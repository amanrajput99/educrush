  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <div className="relative w-full h-[55vh] min-h-[360px] max-h-[520px] overflow-hidden">
        ...
        {/* Strong gradient overlay so text above is readable */}
        ...
        <div className="absolute bottom-0 left-0 right-0 max-w-4xl mx-auto px-6 pb-10">
          ...
          <div className="flex flex-wrap gap-2 mb-4">
            {(blog.tags ?? []).map((tag, i) => (
              <span
                key={tag}
                className={`text-xs px-3 py-1 rounded-full border font-medium ${TAG_COLORS[i % TAG_COLORS.length]}`}
              >
                {tag}
              </span>
            ))}
      ...
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4
          py-6 mb-10 border-b border-slate-800">

          <div className="flex items-center gap-3">
            {/* Avatar */}
            <div className="w-11 h-11 rounded-full bg-gradient-to-br from-emerald-600 to-cyan-700
              flex items-center justify-center font-bold text-white text-base shrink-0 ring-2 ring-emerald-500/20">
        ...
        {blog.content ? (
          <div
            className="
              ...
              prose-h3:text-xl prose-h3:mt-8 prose-h3:mb-3 prose-h3:text-emerald-300
              prose-p:text-slate-300 prose-p:leading-[1.85] prose-p:text-base
              prose-a:text-emerald-400 prose-a:no-underline hover:prose-a:text-emerald-300 hover:prose-a:underline prose-a:font-medium
              prose-strong:text-white prose-strong:font-semibold
              prose-em:text-slate-400
              prose-code:text-emerald-300 prose-code:bg-emerald-950/50 prose-code:border prose-code:border-emerald-800/40 prose-code:px-1.5 prose-code:py-0.5 prose-code:rounded prose-code:text-sm prose-code:font-mono prose-code:before:content-none prose-code:after:content-none
              prose-pre:bg-slate-900 prose-pre:border prose-pre:border-slate-800 prose-pre:rounded-xl prose-pre:shadow-xl
              prose-blockquote:border-l-emerald-500 prose-blockquote:border-l-2 prose-blockquote:text-slate-400 prose-blockquote:italic prose-blockquote:not-italic prose-blockquote:bg-slate-900/50 prose-blockquote:rounded-r-xl prose-blockquote:py-1 prose-blockquote:pr-4
            ...
            <div className="relative z-10">
              ...
              <Link
                ...
                className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl
                  ...
                  text-sm font-medium hover:bg-emerald-900/40 hover:border-emerald-700/60
