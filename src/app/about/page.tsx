...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    siteName: 'EduCrush',
    images: [{ url: '/og-about.png', width: 1200, height: 630, alt: 'About EduCrush' }],
  },
  twitter: { card: 'summary_large_image', title: 'About EduCrush', description: 'Meet the team behind India\'s free student platform.', images: ['/og-about.png'] },
}
