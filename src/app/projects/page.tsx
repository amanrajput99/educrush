...
export const metadata: Metadata = {
  ...
  description: 'Browse free web development projects with full source code. HTML, CSS, JavaScript, React projects for BCA, BTech & Diploma students. Download and learn for free.',
  keywords: ['free web development projects', 'HTML CSS projects download', 'JavaScript projects source code', 'mini projects BTech', 'BCA projects free', 'free source code download', 'EduCrush projects'],
  alternates: { canonical: 'https://educrush.in/projects' },
  openGraph: {
    type: 'website', url: 'https://educrush.in/projects',
