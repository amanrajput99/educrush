...
export const projects: Project[] = [
  {
    name: 'All Projects Coming Soon!',
    slug: 'comingsoon',
    description: 'We are working hard to bring you an amazing collection of projects. Stay tuned for updates!',
    longDescription: 'We are working hard to bring you an amazing collection of projects. Stay tuned for updates! In the meantime, check out our latest projects and experiments on our homepage. We are committed to delivering high-quality, creative web projects that inspire and educate. Thank you for your patience and support!',
    image: 'https://drive.google.com/file/d/1qn7aGlCShTFRxa1SgPMSY5bU8dJTc800/view?usp=drivesdk',
    tags: ['HTML', 'CSS'],
    link: 'https://educrush.in/projects/',
    codeBlocks: [
      {
        language: 'HTML',
        filename: 'index.html',
        code: `"For all upcoming projects, we will provide the structure in the same way: HTML files will contain the markup, 
        CSS files will handle the styling, and each block will include its respective code."`,
      },
      {
        language: 'CSS',
        filename: 'style.css',
        code: `
"For all upcoming projects, we will provide the structure in the same way: HTML files will contain the markup,
 CSS files will handle the styling, and each block will include its respective code."`,
      },
    ],
  },
