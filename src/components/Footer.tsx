...
<a href="https://educrush.in" className="block">
  <div className="w-12 h-12 rounded-full bg-white flex items-center justify-center">
    ...
    />
                            ...
                            <p className="text-sm/6 text-neutral-300 max-w-96">EduCrush helps you build faster by transforming your design vision into fully functional, production-ready UI components.</p>
                    ...
                    <div className="max-w-7xl mx-auto mt-12 pt-4 border-t border-neutral-700 flex justify-between items-center">
                        <p className="text-neutral-400 text-sm">© 2026 EduCrush Design</p>
